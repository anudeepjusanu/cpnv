...
DROP TABLE `tbl_users`;
  ...
  INSERT INTO `tbl_departments` (`department_id`, `department_name`, `is_active`) VALUES
  ...
  ALTER TABLE `tbl_user_departments`
    ADD CONSTRAINT `tbldpt` FOREIGN KEY (`department_id`) REFERENCES `tbl_departments` (`department_id`),
