              ...
              {caseDetails.reason === 'Exposed' && (
                <React.Fragment>
                  <Grid className="detailsList">
                    ...
                    <Typography variant="body1" gutterBottom>
                      {moment(new Date(caseDetails.exposure_date)).format(
                        'MM/DD/YYYY HH:mm',
                      )}
              ...
              {caseDetails.reason === 'Symptoms' && (
                <React.Fragment>
                  <Grid className="detailsList">
                    ...
                    <Typography variant="body1" gutterBottom>
                      {moment(new Date(caseDetails.symptoms_began_date)).format(
                        'MM/DD/YYYY HH:mm',
                      )}
                    </Typography>
                  </Grid>
                  ...
                  {caseDetails.have_consult_doctor == 1 && (
                    <Grid className="detailsList">
                      ...
                      <Typography variant="body1" gutterBottom>
                        {moment(new Date(caseDetails.consult_date)).format(
                          'MM/DD/YYYY',
                        )}
              ...
              {caseDetails.reason === 'Diagnosed' && (
                <React.Fragment>
                  ...
                  <Grid className="detailsList">
                    ...
                    <Typography variant="body1" gutterBottom>
                      {moment(
                        new Date(caseDetails.diagnosis_received_date),
                      ).format('MM/DD/YYYY')}
                    </Typography>
                  </Grid>
                  <Grid className="detailsList">
                    ...
                    <Typography variant="body1" gutterBottom>
                      {moment(new Date(caseDetails.diagnosis_test_date)).format(
                        'MM/DD/YYYY',
                      )}
                    </Typography>
                  </Grid>
                              ...
                              >
                                ...
                                <Grid className="noteWidth ml-10">
                                  {/* <Button
                                    ...
                                    onClick={fnCloseCase}
                                    disabled={caseStatus == 'Case Closed'}
                                  >
                                    Close Case
                                  </Button>
                                  <Typography
