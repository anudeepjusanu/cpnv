...
import { Grid, Button, Typography, Select, TextField, FormControl, MenuItem, InputLabel, Switch, withStyles } from '@material-ui/core';
                                ...
                                <Grid container>
                                    ...
                                    <Grid item xs={12} sm={12}>
                                        <Grid className="contactInfoSpacBtm">
                                            <Typography variant="overline" gutterBottom >Contact Information</Typography>
                                            <Grid container spacing={2} className="formBtmSpace">
                                            <Grid item md={3}>
                                                <div className="form-control">
                                                    <TextField
                                                ...
                                                <FormControl variant="outlined" className="fullWidth">
                                                    ...
                                                    >
                                                        {departmentsList.map((list) => (
                                                            <MenuItem key={list.label} value={list.value}>{list.label}</MenuItem>
                                                        ))}                                                        
                                                    </Select>
                                                </FormControl>
                                            </Grid>
                                    ...
                                    <Grid item xs={12} sm={12}>
                                        <Grid className="contactInfoSpacBtm">
                                            <Grid className="remotelyBlk">
                                                <Typography variant="body2" gutterBottom className="remotelySwitch">
                                                    Are you working remotely ?
                                                    <Typography component="div" className="switchWrap">
                                                        <Grid component="label" container alignItems="center" spacing={1}>
                                                            <Grid item className="switchLabel">No</Grid>
                                                            <Grid item>
                                                                <IOSSwitch checked={isSwitchActionEn} onChange={handleSwitchChange} name="remotely" inputProps={{ 'aria-label': 'secondary checkbox' }} />
                                                            </Grid>
                                                            <Grid item className="switchLabel">Yes</Grid>
                                                        </Grid>
                                                    </Typography>
                                                </Typography>
                                            </Grid>
